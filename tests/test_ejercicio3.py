...
def test_compara_positivo():
    ...
    assert isinstance(resultado, int), 'El resultado debe ser 1 ya que el primero número es mayor que el segundo.'
...
def test_compara_negativo():
    ...
    otro_numero = 9
    resultado = compara(numero, otro_numero)
    assert isinstance(resultado, int), 'El resultado debe ser -1 ya que el segundo número es mayor que el primero.'
    assert resultado == -1, 'El resultado no es el esperado.'
...
def test_compara_cero():
    ...
    otro_numero = 16
    resultado = compara(numero, otro_numero)
    assert isinstance(resultado, int), 'El resultado debe ser 0 ya que los números deben ser iguales.'
